...
class MediaReferenceCrop:
    ...
    def get_crop_left(self) -> float: ...
    def set_crop_left(self, value: float) -> None: ...
    def get_crop_right(self) -> float: ...
    def set_crop_right(self, value: float) -> None: ...
    def get_crop_top(self) -> float: ...
    def set_crop_top(self, value: float) -> None: ...
    def get_crop_bottom(self) -> float: ...
    def set_crop_bottom(self, value: float) -> None: ...
...
class Clip:
    ...
    def get_crop(self) -> MediaReferenceCrop: ...
    def set_crop(self, crop: MediaReferenceCrop) -> None: ...
...
class Stack:
    ...
    def add_track(self, track: Track, insertion_index: int = -1) -> str: ...
    def reorder_track(self, id: str, insertion_index: int) -> bool: ...
    def sync_track_info(self) -> list[SyncTrackInfo]: ...
    def delete_track(self, id: str) -> Optional[Track]: ...
    def set_tracks(self, tracks: list[Track]) -> None: ...
    def sanitize(self) -> None: ...
    def get_track_by_id(self, id: str) -> Optional[tuple[int, Track]]: ...
    def get_track_by_name(self, name: str) -> Optional[tuple[int, Track]]: ...
    def find_tracks_by_name(self, name: str) -> list[tuple[int, Track]]: ...
    ...
    def group_item(self, item_ids: list[str]) -> Optional[int]: ...
    def ungroup_item(self, item_ids: list[str]) -> int: ...
...
class Timeline:
    ...
    def sanitize(self) -> None: ...
    def clear_target_urls(self) -> None: ...
    def get_name(self) -> Optional[str]: ...
    def set_name(self, value: Optional[str]) -> None: ...
    ...
    def get_fonts(self) -> list[FontFace]: ...
    def add_font(
        self,
        family: str,
        url: str,
    ...
    def remove_font(self, family: str) -> bool: ...
    def get_metadata_json(self) -> str: ...
    def set_metadata_json(self, value: str) -> None: ...
    def __str__(self) -> str: ...
