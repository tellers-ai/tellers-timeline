...
class TrackBoundaryGroupInfo(TypedDict):
    start_index: int
    end_index: int
...
class Stack:
    ...
    def add_track(self, track: Track, insertion_index: int = -1) -> bool: ...
    def reorder_track(self, id: str, insertion_index: int) -> bool: ...
    def track_boundary_group_info(self) -> list[TrackBoundaryGroupInfo]: ...
